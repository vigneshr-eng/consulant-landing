  ...
  return (
    <div className="flex flex-col lg:flex-row items-stretch justify-center gap-6">
      ...
      >
        ...
        >
          {/* ── Heading on solid white — no image behind it ── */}
          <div className="absolute z-10" style={{ top: 20, left: 20 }}>
            <h2
              className="font-black text-[#111111] leading-[1.15]"
              style={{ fontSize: 'clamp(26px, 3.2vw, 42px)', letterSpacing: '-0.5px' }}
            >
              Get Your Meetings
            </h2>
          ...
          <div
            ...
            style={{ top: 118, left: 16, right: 16, bottom: 16, borderRadius: 16 }}
          >
            <img
              src={meetingImg}
            ...
            <div className="absolute bottom-4 left-4 flex flex-col gap-1.5 items-start">
              <div
                ...
                style={{ borderRadius: '20px 20px 20px 4px', boxShadow: '0 2px 8px rgba(0,0,0,0.10)' }}
              >
                Released
              </div>
              <div
                className="bg-white py-1.5 px-4 text-sm font-semibold text-slate-900"
                style={{ borderRadius: '4px 20px 20px 20px', boxShadow: '0 2px 8px rgba(0,0,0,0.10)' }}
              >
                with AI Technology
              </div>
            </div>
            ...
            {SLIDER_ITEMS.map((_, i) => (
              <motion.button
                ...
                animate={{
                  ...
                  backgroundColor: i === activeIndex ? '#ffffff' : 'rgba(255,255,255,0.38)',
                }}
